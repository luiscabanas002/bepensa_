...
public class FactorHolder extends BaseViewHolder {
    ...
    public interface FactorListener {
        void Seleccionar(Factores item);
    }

    public FactorHolder(View itemView, OnViewHolderClickListener onViewHolderClickListener) {
        super(itemView, onViewHolderClickListener);
        ButterKnife.bind(this, itemView);
    }

    public FactorHolder(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void config(Context mContext, String tipo, final Factores item, final FactorListener mFactorListener) {
        ...
        mRelativeLayoutIcons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mFactorListener.Seleccionar(item);
            }
        });
