namespace BepensaService.Models
{
    ...
    [Table("bepensa.registros_condiciones")]
    public partial class registros_condiciones
    {
        [Key]
        public long id_registro_condicion { get; set; }
        ...
        [StringLength(5000)]
        public string maquina_equipo_zona { get; set; }
